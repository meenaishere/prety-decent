...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/Save_restricted_content_base")],
        [Button.url("Contact Me", url="https://t.me/Chat_support_cc_bot")],
    ]
...
S = "/start"
START_PIC = "https://graph.org/file/0f457de1eb8005d41e3c6.jpg"
TEXT = "Hey! I am Advance Content Saver Bot, do login in bot by /login and start saving from public/private channels/groups via sending post link.\n\n👉🏻 Execute /twice for download 2 files."


M = "/plan"
PREMIUM_PIC = "plan.png"
PRE_TEXT = """💰 **Premium Price**: Starting from $2 or 100 INR accepted via **__Amazon Gift Card__** (terms and conditions apply).
...
async def plan_command(event):
    ...
    buttons = [
        [Button.url("Send Gift Card Code", url="https://t.me/Chat_support_cc_bot")]
    ]
...
async def term_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.url("Query?", url="https://t.me/Chat_support_cc_bot"),
         Button.url("Channel", url="https://t.me/Save_restricted_content_base")]
    ]
...
REPO_URL = "https://t.me/Save_restricted_content_base"
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Advance Content Saver Bot](https://t.me/save_restrict11_free_bot)**__"  # Set caption to the title of the video
